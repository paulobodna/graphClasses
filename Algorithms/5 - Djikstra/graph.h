...
// verifica se um vetor ainda tem elementos com -1
// simula a empty_queue em vetor
int not_empty(int *Q, int n);

// extrai a posicao que contem a menor distancia ate o momento
// e a marca com -1, retornando a posicao
// simula a HEAP em vetor
int extract_min(int *Q, int n);

// Algoritmo de Dijkstra:
// encontra o menor caminho entre um vertice begin e um end
